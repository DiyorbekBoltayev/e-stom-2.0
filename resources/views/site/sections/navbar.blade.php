    ...
    <div class="container d-flex align-items-center">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav m-auto">
                <li class="nav-item active"><a href="{{route('index')}}" class="nav-link pl-0">{{__('others.menu.main')}}</a></li>
                <li class="nav-item"><a href="{{route('about')}}" class="nav-link">{{__('others.menu.about')}}</a></li>
